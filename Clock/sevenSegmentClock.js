...
export default function makeSevenSegmentDisplay(x,y){
    ...
    return (a,b,c,d,e,f,g)=>{
        context.fillStyle=a?'red':'dimGray';
        makeTop(x+25,y+10,60,10)
        context.fillStyle=b?'red':'dimGray';
        makeTop(x+25,y+70,60,10)
        context.fillStyle=c?'red':'dimGray';
        makeTop(x+25,y+130,60,10)
        context.fillStyle=d?'red':'dimGray';
        context.save()
        context.translate(40,80)
        context.rotate(toRad(90));
        makeTop(4,20,54,10)
        context.fillStyle=e?'red':'dimGray';
        makeTop(4,-30,54,10)
        context.fillStyle=f?'red':'dimGray';
        makeTop(-58,20,-6,10)
        context.fillStyle=g?'red':'dimGray';
        makeTop(-58,-30,-6,10)
        context.restore()
        return canvas
    }
